...
/*echo '<pre>';
 ...
 ?>
    ...
    <div class="col-md-12">
    <p><strong>Kumaripati,Lalitpur<br></strong>
...
<div class="embed-responsive embed-responsive-16by9">
      ...
      <div class="nameinput" style="margin-top:5px;">
      ...
      <textarea rows="5" cols="70" class="form-control" placeholder="Message" name="visitor_message" required></textarea>
